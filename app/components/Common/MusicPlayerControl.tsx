    ...
    <div className="fixed bottom-0 left-0 right-0 z-50">
      ...
      {showLyrics && (
        <div className="flex justify-center mb-2.5">
          <div className="bg-white/30 dark:bg-black/40 backdrop-blur-xl border border-white/30 dark:border-white/20 rounded-2xl shadow-lg w-full max-w-6xl mx-4">
      ...
      <div className="flex justify-center">
        <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-lg border border-gray-200/50 dark:border-gray-700/50 rounded-2xl shadow-2xl shadow-black/10 w-full mx-[64px]">
          <div className="px-[50px] py-4">
            <div className="flex items-center h-[50px] gap-[30px]" >
              {/* 左侧：封面和音乐信息 */}
              ...
              <div className="flex items-center space-x-2 justify-end flex-1 min-w-0">
                {/* 进度条 - 长度翻倍 */}
                <div className="flex items-center space-x-2 flex-1 max-w-md min-w-0 hidden md:flex">
                ...
                <div className="flex items-center space-x-2 flex-shrink-0 hidden lg:flex">
                  ...
                  <input
                    ...
                    className="w-24 h-1 bg-gray-200 dark:bg-gray-700 rounded-full appearance-none cursor-pointer [&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:h-3 [&::-webkit-slider-thumb]:w-3 [&::-webkit-slider-thumb]:rounded-full [&::-webkit-slider-thumb]:bg-gradient-to-br [&::-webkit-slider-thumb]:from-purple-500 [&::-webkit-slider-thumb]:to-pink-500 [&::-webkit-slider-thumb]:cursor-pointer [&::-webkit-slider-thumb]:shadow-md [&::-webkit-slider-thumb]:transition-all [&::-webkit-slider-thumb]:duration-200 [&::-webkit-slider-thumb]:hover:scale-110 [&::-webkit-slider-thumb]:hover:shadow-lg [&::-moz-range-thumb]:h-3 [&::-moz-range-thumb]:w-3 [&::-moz-range-thumb]:rounded-full [&::-moz-range-thumb]:bg-gradient-to-br [&::-moz-range-thumb]:from-purple-500 [&::-moz-range-thumb]:to-pink-500 [&::-moz-range-thumb]:cursor-pointer [&::-moz-range-thumb]:border-0 [&::-moz-range-thumb]:shadow-md [&::-moz-range-thumb]:transition-all [&::-moz-range-thumb]:duration-200 [&::-moz-range-thumb]:hover:scale-110 [&::-moz-range-thumb]:hover:shadow-lg"
                    style={{
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-full transition-all duration-200 flex-shrink-0 hover:scale-105 text-xs font-medium ${showLyrics
                ...
                <button
                  ...
                  className={`p-2 rounded-full transition-all duration-200 flex-shrink-0 hover:scale-105 ${isFavorite
